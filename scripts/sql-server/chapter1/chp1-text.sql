...
IF
    NOT EXISTS (SELECT name
                FROM sys.databases
                WHERE name = N'cpsc441_chp1_text')
CREATE DATABASE [cpsc441_chp1_text];
GO

USE cpsc441_chp1_text;
...
IF
    NOT EXISTS (SELECT TABLE_NAME
                FROM INFORMATION_SCHEMA.TABLES
                WHERE TABLE_NAME = N'EMPLOYEESKILLS')
    BEGIN
