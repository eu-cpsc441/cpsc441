...
IF
    ...
    BEGIN
        ...
        INSERT INTO EMPLOYEE VALUES ('155', 'Ritula', 'Annelise', '', 'PROF', '8/1/1990', '5/24/1957');
        INSERT INTO EMPLOYEE VALUES ('160', 'Smith', 'Robert', 'T', 'PROF', '8/1/1992', '6/19/1955');
        INSERT INTO EMPLOYEE VALUES ('161', 'Watson', 'George', 'F', 'CUST', '11/1/1994', '10/2/1962');
        INSERT INTO EMPLOYEE VALUES ('162', 'Rob', 'Peter', '', 'PROF', '8/1/1981', '6/20/1940');
        INSERT INTO EMPLOYEE VALUES ('165', 'Williamson', 'Kathryn', 'A', 'CLRK', '6/15/1992', '11/17/1968');
        INSERT INTO EMPLOYEE VALUES ('166', 'Herndon', 'Jill', 'M', 'TECH', '8/18/1990', '8/29/1965');
        INSERT INTO EMPLOYEE VALUES ('173', 'Teng', 'Weston', 'J', 'TECH', '7/15/1980', '11/17/1951');
        INSERT INTO EMPLOYEE VALUES ('191', 'Dexter', 'Willa', 'N', 'PROF', '8/1/1984', '5/17/1953');
        INSERT INTO EMPLOYEE VALUES ('195', 'Williams', 'Herman', 'H', 'PROF', '8/1/1988', '11/19/1955');
        INSERT INTO EMPLOYEE VALUES ('209', 'Smith', 'Melanie', 'K', 'PROF', '8/1/1983', '5/24/1946');
        INSERT INTO EMPLOYEE VALUES ('228', 'Coronel', 'Carlos', 'M', 'PROF', '8/1/1988', '5/16/1949');
        INSERT INTO EMPLOYEE VALUES ('231', 'Shebert', 'Rebecca', 'A', 'CUST', '2/21/1994', '2/27/1963');
        INSERT INTO EMPLOYEE VALUES ('297', 'Jones', 'Hermine', '', 'PROF', '1/1/1985', '7/4/1950');
        INSERT INTO EMPLOYEE VALUES ('299', 'Stoddard', 'Doreen', 'L', 'PROF', '8/1/1994', '4/25/1960');
        INSERT INTO EMPLOYEE VALUES ('301', 'Osaki', 'Ismael', 'K', 'PROF', '8/1/1989', '5/25/1952');
        INSERT INTO EMPLOYEE VALUES ('333', 'Jordan', 'Julian', 'H', 'TECH', '4/23/1991', '7/16/1968');
        INSERT INTO EMPLOYEE VALUES ('335', 'Okomoto', 'Ronald', 'F', 'PROF', '8/1/1975', '3/3/1944');
        INSERT INTO EMPLOYEE VALUES ('342', 'Smith', 'Robert', 'A', 'PROF', '8/1/1978', '12/30/1937');
        INSERT INTO EMPLOYEE VALUES ('387', 'Smithson', 'George', 'D', 'PROF', '8/1/1982', '10/1/1948');
        INSERT INTO EMPLOYEE VALUES ('401', 'Blalock', 'James', 'G', 'PROF', '8/1/1981', '3/15/1945');
        INSERT INTO EMPLOYEE VALUES ('412', 'Smith', 'Robert', 'E', 'CUST', '6/24/1985', '9/25/1963');
        INSERT INTO EMPLOYEE VALUES ('425', 'Matler', 'Ralph', 'F', 'PROF', '8/1/1995', '12/2/1973');
        INSERT INTO EMPLOYEE VALUES ('435', 'Doornberg', 'Anne', 'D', 'PROF', '8/1/1992', '10/2/1963');
    END
/* -- */
...
IF
    ...
    BEGIN
        ...
        INSERT INTO STUDENT
        VALUES ('321452', 'Bowser', 'William', 'C', '2/12/2000', '42', 'So', '2.84', '0', 'BIOL', '2134', '205');
        INSERT INTO STUDENT
        VALUES ('324257', 'Smithson', 'Anne', 'K', '11/15/2001', '81', 'Jr', '3.27', '1', 'CIS', '2256', '222');
        INSERT INTO STUDENT
        VALUES ('324258', 'Brewer', 'Juliette', '', '8/23/1999', '36', 'So', '2.26', '1', 'ACCT', '2256', '228');
        INSERT INTO STUDENT
        VALUES ('324269', 'Oblonski', 'Walter', 'H', '9/16/1996', '66', 'Jr', '3.09', '0', 'CIS', '2114', '222');
        INSERT INTO STUDENT
        VALUES ('324273', 'Smith', 'John', 'D', '12/30/1988', '102', 'Sr', '2.11', '1', 'ENGL', '2231', '199');
        INSERT INTO STUDENT
        VALUES ('324274', 'Katinga', 'Raphael', 'P', '10/21/2000', '114', 'Sr', '3.15', '0', 'ACCT', '2267', '228');
        INSERT INTO STUDENT
        VALUES ('324291', 'Robertson', 'Gerald', 'T', '4/8/1999', '120', 'Sr', '3.87', '0', 'EDU', '2267', '311');
        INSERT INTO STUDENT
        VALUES ('324299', 'Smith', 'John', 'B', '11/30/2000', '15', 'Fr', '2.92', '0', 'ACCT', '2315', '230');
    END
/* -- */
...
IF
    NOT EXISTS (SELECT TABLE_NAME
                FROM INFORMATION_SCHEMA.TABLES
                WHERE TABLE_NAME = N'qrySTUDENTfirst7Fields')
    BEGIN
        ...
        INSERT INTO qrySTUDENTfirst7Fields VALUES ('321452', 'Bowser', 'William', 'C', '2/12/1985', '42', 'So');
        INSERT INTO qrySTUDENTfirst7Fields VALUES ('324257', 'Smithson', 'Anne', 'K', '11/15/1991', '81', 'Jr');
        INSERT INTO qrySTUDENTfirst7Fields VALUES ('324258', 'Brewer', 'Juliette', '', '8/23/1979', '36', 'So');
        INSERT INTO qrySTUDENTfirst7Fields VALUES ('324269', 'Oblonski', 'Walter', 'H', '9/16/1986', '66', 'Jr');
        INSERT INTO qrySTUDENTfirst7Fields VALUES ('324273', 'Smith', 'John', 'D', '12/30/1968', '102', 'Sr');
        INSERT INTO qrySTUDENTfirst7Fields VALUES ('324274', 'Katinga', 'Raphael', 'P', '10/21/1989', '114', 'Sr');
        INSERT INTO qrySTUDENTfirst7Fields VALUES ('324291', 'Robertson', 'Gerald', 'T', '4/8/1983', '120', 'Sr');
        INSERT INTO qrySTUDENTfirst7Fields VALUES ('324299', 'Smith', 'John', 'B', '11/30/1996', '15', 'Fr');
    END
/* -- */
...
IF
    NOT EXISTS (SELECT TABLE_NAME
                FROM INFORMATION_SCHEMA.TABLES
                WHERE TABLE_NAME = N'qrySTUDENTremainingFields')
    BEGIN
