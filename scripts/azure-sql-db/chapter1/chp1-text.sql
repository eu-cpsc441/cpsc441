...
CREATE SCHEMA c1_text;
GO

CREATE TABLE c1_text.EMPLOYEE
(
...
CREATE TABLE c1_text.CERTIFIED
(
    EMPLOYEE_ID    VARCHAR(6) REFERENCES c1_text.EMPLOYEE,
    SKILL_ID       NUMERIC(6, 0) REFERENCES c1_text.SKILL,
    CERTIFIED_DATE DATETIME,
    PRIMARY KEY (EMPLOYEE_ID, SKILL_ID)
);


INSERT INTO c1_text.CERTIFIED
...
CREATE TABLE c1_text.EMPLOYEESKILLS
(
...
INSERT INTO c1_text.EMPLOYEESKILLS
...
VALUES (2, '08273', 'Marco Bienz', 'Analyst', '7/28/2012', 'Basic Web Design',
        ...
        'Evaluate and Redesign cross-functional internal and external business processes.', '8/19/2018', NULL,
        NULL,
        NULL);
...
VALUES (4, '03373', 'Franklin Johnson, Jr.', 'Purchasing Agent', '3/15/2008', 'Advanced Spreadsheets',
        'Use of advanced functions, user-defined functions, and macroing.', '6/20/2017', NULL, NULL, NULL, NULL,
        NULL,
        NULL);
...
INSERT INTO c1_text.EMPLOYEESKILLS
VALUES (6, '10282', 'Richardson, Amanda', 'Clerk', '4/11/2017', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        NULL);
...
VALUES (7, '09382', 'Jessica Johnson', 'Database Programmer', '8/2/2016', 'Basic DB Design',
        ...
        'Create simple data retrieval and manipulation statements in SQL.', '8/2/2018',
        'Advanced DB Manipulation',
        'Use of advanced data manipulation methods for multi-table inserts, set operations, and correlated subqueries',
        '5/1/2019');

INSERT INTO c1_text.EMPLOYEESKILLS
VALUES (8, '14311', 'Duong, Lee', 'Programmer', '9/1/2020', 'Basic Web Design', NULL, '9/1/2022', NULL, NULL,
        NULL,
        NULL, NULL, NULL);

INSERT INTO c1_text.EMPLOYEESKILLS
VALUES (9, NULL, NULL, NULL, NULL, 'Master Database Programming',
        'Create integrated trigger and procedure packages for a distributed environment.', NULL, NULL, NULL,
        NULL, NULL,
        NULL, NULL);

INSERT INTO c1_text.EMPLOYEESKILLS
VALUES (10, NULL, NULL, NULL, NULL, 'Basic Spreadsheets', 'Create single tab worksheets with basic formulas',
        NULL,
...
INSERT INTO c1_text.EMPLOYEESKILLS
VALUES (15, '13932', 'Lee, Megan', 'Programmer', '9/29/2019', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        NULL);

/* -- */

CREATE TABLE c1_text.AGENT
(
    A_NAME    varchar(15),
    A_PHONE   varchar(12),
...
INSERT INTO c1_text.AGENT
VALUES ('Alex B. Alby', '713-228-1249', '123 Toll, Nash, TN', '37119', '11/1/2006', '26566.24', '6641.56',
        '2125.3',
        '132735.75', '3');
INSERT INTO c1_text.AGENT
VALUES ('Leah F. Hahn', '615-882-1244', '334 Main, Fox, KY', '25246', '5/23/1992', '32213.76', '8053.44',
        '2577.1',
        '138967.35', '0');
INSERT INTO c1_text.AGENT
VALUES ('John T. Okon', '615-123-5589', '452 Elm, New, TN', '36155', '6/15/2011', '23198.29', '5799.57',
        '1855.86',
        '127093.45', '2');
...
INSERT INTO c1_text.CUSTOMER
VALUES ('Alfred A. Ramas', '615-844-2573', '218 Fork Rd., Babs, TN', '36123', 'Leah F. Hahn', '615-882-1244',
        'T1',
        '100', '4/5/2022');
INSERT INTO c1_text.CUSTOMER
VALUES ('Leona K. Dunne', '713-894-1238', 'Box 12A, Fox, KY', '25246', 'Alex B. Alby', '713-228-1249', 'T1',
        '250',
        '6/16/2022');
INSERT INTO c1_text.CUSTOMER
VALUES ('Kathy W. Smith', '615-894-2285', '125 Oak Ln, Babs, TN', '36123', 'Leah F. Hahn', '615-882-2144', 'S2',
        '150',
        '1/29/2023');
INSERT INTO c1_text.CUSTOMER
VALUES ('Paul F. Olowski', '615-894-2180', '217 Lee Ln., Babs, TN', '36123', 'Leah F. Hahn', '615-882-1244',
        'S1',
        '300', '10/14/2022');
INSERT INTO c1_text.CUSTOMER
VALUES ('Myron Orlando', '615-222-1672', 'Box 111, New, TN', '36155', 'Alex B. Alby', '713-228-1249', 'T1',
        '100',
        '12/28/2022');
INSERT INTO c1_text.CUSTOMER
VALUES ('Amy B. O''Brian', '713-442-3381', '387 Troll Dr., Fox, KY', '25246', 'John T. Okon', '615-123-5589',
        'T2',
        '850', '9/22/2022');
INSERT INTO c1_text.CUSTOMER
VALUES ('James G. Brown', '615-297-1228', '21 Tye Rd., Nash, TN', '37118', 'Leah F. Hahn', '615-882-1244', 'S1',
        '120',
        '3/25/2023');
INSERT INTO c1_text.CUSTOMER
VALUES ('George Williams', '615-290-2556', '155 Maple, Nash, TN', '37119', 'John T. Okon', '615-123-5589', 'S1',
        '250',
        '7/17/2022');
INSERT INTO c1_text.CUSTOMER
VALUES ('Anne G. Farriss', '713-382-7185', '2119 Elm, Crew, KY', '25432', 'Alex B. Alby', '713-228-1249', 'T2',
        '100',
        '12/3/2022');
INSERT INTO c1_text.CUSTOMER
VALUES ('Olette K. Smith', '615-297-3809', '2782 Main, Nash, TN', '37118', 'John T. Okon', '615-123-5589', 'S2',
        '500',
        '3/14/2023');
