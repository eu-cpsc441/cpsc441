...
IF
    NOT EXISTS (SELECT name
                FROM sys.databases
                WHERE name = N'cpsc441_chp8_saleco2')
CREATE DATABASE [cpsc441_chp8_saleco2];
GO

USE cpsc441_chp8_saleco2;
...
IF
    ...
    BEGIN
        ...
        INSERT INTO INVOICE VALUES ('1001', '10014', '1/16/2022', '24.90', '1.99', '26.89');
        INSERT INTO INVOICE VALUES ('1002', '10011', '1/16/2022', '9.98', '0.80', '10.78');
        INSERT INTO INVOICE VALUES ('1003', '10012', '1/16/2022', '153.85', '12.31', '166.16');
        INSERT INTO INVOICE VALUES ('1004', '10011', '1/17/2022', '34.97', '2.80', '37.77');
        INSERT INTO INVOICE VALUES ('1005', '10018', '1/17/2022', '70.44', '5.64', '76.08');
        INSERT INTO INVOICE VALUES ('1006', '10014', '1/17/2022', '397.83', '31.83', '429.66');
        INSERT INTO INVOICE VALUES ('1007', '10015', '1/17/2022', '34.97', '2.80', '37.77');
        INSERT INTO INVOICE VALUES ('1008', '10011', '1/17/2022', '399.15', '31.93', '431.08');
    END
...
IF
    ...
    BEGIN
        ...
        INSERT INTO PRODUCT VALUES ('23109-HB', 'Claw hammer', '1/20/2022', '23', '10', '9.95', '0.1', '21225');
        INSERT INTO PRODUCT VALUES ('23114-AA', 'Sledge hammer, 12 lb.', '1/2/2022', '8', '5', '14.40', '0.05', '');
        INSERT INTO PRODUCT
        ...
        INSERT INTO PRODUCT VALUES ('PVC23DRT', 'PVC pipe, 3.5-in., 8-ft', '2/20/2022', '188', '75', '5.87', '0', '');
        INSERT INTO PRODUCT
